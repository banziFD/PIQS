...
public class SelSearchDetailPanel3 extends JPanel{
	AppMainFrame mainFrame;

    SelSearchDetailPanel3(AppMainFrame parentFrame) {
        super();
    	...
    	labelname3_2[0].setText("牙刷");
    	labelname3_1[0].setText(null);
    		javax.swing.ImageIcon icon = new javax.swing.ImageIcon("F:\\wallpapers\\牙刷.jpg");
            ...
            button7_5.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent a) {
                	mainFrame.closeSelSearchDetailPanel3();
