...
public class SelSearchDetailPanel4 extends JPanel {
	AppMainFrame mainFrame;

	SelSearchDetailPanel4(AppMainFrame parentFrame) {
		super();
		...
		labelname3_2[0].setText("洗衣液");
		labelname3_1[0].setText(null);
		javax.swing.ImageIcon icon = new javax.swing.ImageIcon("F:\\wallpapers\\洗衣液.jpg");
		...
		button7_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent a) {
				mainFrame.closeSelSearchDetailPanel4();
